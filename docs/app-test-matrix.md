...
| Dock | PENDING | PARTIAL | PENDING | N/A | PENDING | PENDING | 2026-09-07 identity cleanup makes pinned and unpinned running Browser/ChatGPT/YouTube icons consistent and keeps Kamihi Browser visually distinct from Safari. Still verify every pinned/running icon, close/reopen state, hover/magnification smoothness and auto-hide behavior in Desktop Lab plus physical display. |
