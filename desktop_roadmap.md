...
- **Next rotation focus: 2 — iPadOS-style shell/design system.** Preserve the user's trackpad-first phone controller and choose a new highest-impact shell/accessibility issue without repeating the existing theme/transparency work.