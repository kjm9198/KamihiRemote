...
| 42 | Battery Saver Desktop Mode | PARTIAL | Low Power Mode/override/thermal state service exists; Focus 9 unloads inactive web-backed windows while conservation is active, keeping the active app live. Long-idle policy and measured device thresholds remain TODO. |
...
| 44 | Thermal protection | PARTIAL | Live ProcessInfo thermal monitoring and saver trigger exist; serious/critical thermal pressure participates in inactive web-window sleeping. Physical thermal profiling and richer media throttling remain TODO. |
...
- **Next rotation focus: 8 — native desktop apps.** Choose the highest-impact unfinished native-app issue without repeating prior Notes/Files/PDF work; prioritize Photos permission flow, desktop capture/share, or richer Files export using only public APIs.