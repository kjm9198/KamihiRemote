...
- **Next rotation focus: 1 — RayNeo Air 4 Pro external-display fidelity.** Choose the highest-impact unfinished negotiated-resolution/refresh, safe-area/overscan, readable-scaling, diagnostics or reconnect issue without repeating the existing backing-ratio diagnostics work.