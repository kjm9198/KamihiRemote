...
- **Next rotation focus: 6 — Browser/web-app quality.** Choose the highest-impact unfinished browser issue without repeating the existing retained-tab, popup-to-tab, bookmark/history/find, or WebView lifecycle work; preserve session continuity and the full-trackpad controller contract.
