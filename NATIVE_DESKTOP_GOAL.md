...
- **Next rotation focus: 7 — Phone Takeover/authentication.** Choose the highest-impact unfinished public-API auth/handoff issue without reading, storing or logging raw credentials; keep Password AutoFill/passkeys/CAPTCHA/file-picker and provider-specific login behavior marked physical-only until verified on a real iPhone.
